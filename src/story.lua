function map_init()
   g_rooms = gun_vals([[
      ...
      { m=0, c=4, qx=2, qy=0,
         ...
         w = 12,  h = 10,
         d={VILLAGE,12,3},
         {'pot',POT_03,65.5,6.5,49},
         {'pot',POT_04,65.5,7.5,49}, {'pot',POT_05,66.5,7.5,49},
         {'pot',POT_06,66.5,8.5,49}, {'pot',POT_07,67.5,8.5,49},
         {'pot',POT_08,65.5,8.5,49},

         {'pot',POT_29,74.5,6.5,49},
         {'pot',POT_09,74.5,7.5,49}, {'pot',POT_10,73.5,7.5,49},
         {'pot',POT_11,73.5,8.5,49}, {'pot',POT_12,72.5,8.5,49},
         {'pot',POT_13,74.5,8.5,49},
         {'lark',70,2}
      },
      -- TEACH_STUDIO
      { m=0, c=4, qx=0, qy=0,
